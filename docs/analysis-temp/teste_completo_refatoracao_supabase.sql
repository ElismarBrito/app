...
-- ============================================
-- IMPORTANTE: Veja o resultado do EXPLAIN ANALYZE
...
SELECT 'TESTE 2: Verificar Uso do Índice idx_calls_user_status' AS teste,
       'Veja o resultado abaixo do EXPLAIN ANALYZE' AS instrucao;
...
SELECT 
    ...
    '1. Testar no Dashboard (F12 → Network)' AS passo,
    '2. Verificar se queries têm filtros na URL' AS detalhe
UNION ALL
SELECT 
    'PRÓXIMOS PASSOS',
    '3. Verificar se dashboard carrega mais rápido',
    'Tempo esperado: < 1 segundo'
UNION ALL
SELECT 
    'PRÓXIMOS PASSOS',
    '4. Se todos os testes passaram = ✅ SUCESSO!',
